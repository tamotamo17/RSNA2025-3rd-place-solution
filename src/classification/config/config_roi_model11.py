...
class DataConfig:
    ...
    out_size_zyx: List[int] = field(default_factory=lambda: [224, 224, 224])  # (Z_out, H_out, W_out)
    map_size_zyx: List[int] = field(default_factory=lambda: [28, 28, 28])
...
class ModelConfig:
    ...
    num_classes: int = 14
    drop_rate: float = 0.2
    map_size: List[int] = field(default_factory=lambda: [28, 28, 28])
...
class TrainingConfig:
    ...
    epochs: int = 100
    num_workers: int = 8
    output_dir: str = "/home/tamoto/kaggle/RSNA2025/outputs/model11_3dv3_lossv2_mm90_imgsize224"
