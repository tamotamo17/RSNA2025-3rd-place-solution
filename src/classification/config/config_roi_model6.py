...
class DataConfig:
    ...
    map_size_zyx: List[int] = field(default_factory=lambda: [24, 24, 24])
...
class ModelConfig:
    ...
    num_classes: int = 14
    drop_rate: float = 0.2
    map_size: List[int] = field(default_factory=lambda: [24, 24, 24])
...
class TrainingConfig:
    ...
    epochs: int = 100
    num_workers: int = 8
    output_dir: str = "/home/tamoto/kaggle/RSNA2025/outputs/model6_3dv3_lossv2_mm120_imgsize192"
