...
class DataConfig:
    ...
    volume_size_mm: List[float] = field(default_factory=lambda: [120.0, 120.0, 120.0])
    out_size_zyx: List[int] = field(default_factory=lambda: [192, 192, 192])  # (Z_out, H_out, W_out)
    map_size_zyx: List[int] = field(default_factory=lambda: [12, 12, 12])
...
class ModelConfig:
    ...
    num_classes: int = 14
    drop_rate: float = 0.2
    map_size: List[int] = field(default_factory=lambda: [12, 12, 12])
...
class TrainingConfig:
    ...
    epochs: int = 100
    num_workers: int = 8
    output_dir: str = "/home/tamoto/kaggle/RSNA2025/outputs/model5_3dv2_lossv2_mm120_imgsize192"
