...
class DataConfig:
    ...
    out_size_zyx: List[int] = field(default_factory=lambda: [128, 128, 128])  # (Z_out, H_out, W_out)
    map_size_zyx: List[int] = field(default_factory=lambda: [8, 8, 8])
...
class ModelConfig:
    ...
    name: str = "aneurysm_3d_v2"
    backbone: str = "resnet18"#"resnet18"# "resnet18"  # "resnet34"
    in_chans: int = 1
    num_classes: int = 14
    drop_rate: float = 0.2
    map_size: List[int] = field(default_factory=lambda: [8, 8, 8])
...
class LossConfig:
    ...
    name: str = "aneurysm_3d_roi"  # "patch_binary_focal"  # Changed default to patch-based loss
    loss_type: str = "multi"
...
class TrainingConfig:
    ...
    epochs: int = 100
    num_workers: int = 8
    output_dir: str = "/home/tamoto/kaggle/RSNA2025/outputs/model3_3dv2_lossv1_focal_mm90_imgsize128"
