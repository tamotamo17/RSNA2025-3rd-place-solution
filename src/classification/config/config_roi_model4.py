...
class DataConfig:
    ...
    map_size_zyx: List[int] = field(default_factory=lambda: [32, 32, 32])
...
class ModelConfig:
    ...
    num_classes: int = 14
    drop_rate: float = 0.2
    map_size: List[int] = field(default_factory=lambda: [32, 32, 32])
...
class TrainingConfig:
    ...
    epochs: int = 100
    num_workers: int = 8
    output_dir: str = "/home/tamoto/kaggle/RSNA2025/outputs/model4_3dv7_lossv2_mm90_imgsize128"
